...
public class SalesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        qv[0] = userData[1];
        qv[1] = userData[2];
        getAPIObject("getdailysales", qv);
        recyclerView = findViewById(R.id.recyclerview);
        todaySales = findViewById(R.id.txtTotalSales);

        btnSales = findViewById(R.id.btnSales);
        btnSales.setOnClickListener(view -> {
            Intent intent = new Intent(SalesActivity.this, MakeSalesActivity.class);
            ...
            try (Response response = client.newCall(request).execute()) {
                ...
                runOnUiThread(() -> {
                    try {
                        ...
                        if(endpoint.equals("getdailysales")){
                            String msg;
                            ...
                            switch (type.toLowerCase()){
                                case "success":
                                    ...
                                    salesList = gson.setDateFormat("yyyy-MM-dd hh:mm:ss").create().fromJson(us, token.getType());
